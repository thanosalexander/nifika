 ...
 * Generated for Laravel 5.3.31 on 2019-03-20.
 *
...
namespace Collective\Html { 
    ...
    class FormFacade {
         ...
         * @static 
         */ 
        public static function labelRequired($name, $value = null, $options = array())
        {
            return \Collective\Html\FormBuilder::labelRequired($name, $value, $options);
        }
         ...
         * @static 
         */ 
        public static function checkboxLabeled($name, $label = '', $value = 1, $checked = null, $options = array())
        {
            return \Collective\Html\FormBuilder::checkboxLabeled($name, $label, $value, $checked, $options);
        }
