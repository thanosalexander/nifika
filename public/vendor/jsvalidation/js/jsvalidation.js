...
$.extend( $.validator, {
    ...
    prototype: {
        ...
        hideThese: function( errors ) {
            ...
            this.addWrapper( errors ).addClass('hidden');
        },
        ...
        defaultShowErrors: function() {
            ...
            this.hideErrors();
            this.addWrapper( this.toShow ).removeClass('hidden');
        },
        ...
        showLabel: function( element, message ) {
            ...
            if ( error.length ) {
                ...
                if ( this.settings.wrapper ) {
                    ...
                    place = error.addClass('hidden').removeClass('hidden').wrap( "<" + this.settings.wrapper + "/>" ).parent();
                }
...
$.extend(true, laravelValidation, {
    ...
    helpers: {
        ...
        getSize: function getSize(obj, element, value) {
            ...
            } else if (this.hasNumericRules(element) && this.is_numeric(value)) {
